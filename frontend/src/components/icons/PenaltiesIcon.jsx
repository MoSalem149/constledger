export default function PenaltiesIcon({ className }) {
  return (
    <svg
      className={className}
      width="24"
    ...
    >
      ...
      <path d="M12 9V13" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 17H12.01" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
