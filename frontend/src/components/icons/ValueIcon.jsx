export default function ValueIcon({ className }) {
  return (
    <svg
      className={className}
      width="16"
      ...
      aria-hidden="true"
    >
      <g clipPath="url(#clipValue)">
        <path d="M8 1.33334V14.6667" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
