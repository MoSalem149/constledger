...
const DashboardHeader = ({ projectCount, userName, canAddProject }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 font-sans">
      ...
      {canAddProject && (
        <Link
          to="/contracts/upload"
          className="inline-flex  bg-button-active shadow-[0px_0px_4px_0px_rgba(255,72,0,1.00)] text-text-light text-sm font-medium px-4 py-2.5  rounded-3xl hover:opacity-90 transition-opacity w-fit"
        >
