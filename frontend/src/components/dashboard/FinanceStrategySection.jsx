...
const StrategyRow = ({ contract, planItem }) => {
  return (
    <Link
      ...
      className="flex flex-col gap-2 border-b border-gray-100 py-3 font-sans transition-colors last:border-b-0 hover:bg-gray-50/50 min-[480px]:flex-row min-[480px]:items-center min-[480px]:justify-between"
    >
      ...
      <span className="pl-5 text-xs font-medium text-text-secondary min-[480px]:max-w-[45%] min-[480px]:shrink-0 min-[480px]:pl-0 min-[480px]:text-right min-[480px]:text-sm min-[480px]:text-text-primary">
...
export default function FinanceStrategySection({ contracts, plans }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
      ...
      <div className="flex min-w-0 flex-col rounded-lg bg-bg-cards1 p-4 shadow-[0px_2px_8px_0px_rgba(136,135,135,0.10)] sm:p-6 xl:col-span-2">
        <div className="mb-4">
      ...
      <div className="flex min-w-0 flex-col rounded-lg bg-bg-cards1 p-4 shadow-[0px_2px_8px_0px_rgba(136,135,135,0.10)] sm:p-6">
        <div className="mb-7">
