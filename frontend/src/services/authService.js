...
export const authService = {
   ...
   *
   * Errors are swallowed intentionally: if the cookie is already expired
   * or missing the server returns 401, but the local session must still
   * be cleared. Never throw from logout.
   */
